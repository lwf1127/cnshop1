 ...
 <head>
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2>欢迎管理员 Tony</h2>
			<p id="page-intro"><?php echo ($action); ?>类别</p>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3><?php echo ($action); ?>类别<?php echo ($type); ?></h3>
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab2">
						...
						<form action="<?php echo U('Type/save_type');?>" method="post">
							
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								
								<p>
									<label>类别名称</label>
										<input class="text-input small-input" type="text" id="small-input" name="cname" value="<?php echo ($type['cname']); ?>" />
								</p>

								<p>
								<?php if(ACTION_NAME=='edit_type'): ?><input type="hidden" name="id" value="<?php echo ($_GET['id']); ?>" /><?php endif; ?>
									<input class="button" type="submit" value="<?php echo ($action); ?>" />
								</p>
