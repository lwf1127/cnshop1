 ...
 <head>
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<h2>欢迎管理员 Tony</h2>
			<p id="page-intro"><?php echo ($classes); ?></p>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab2">
						...
						<form enctype="multipart/form-data" action="<?php echo U('Goods/save_goods');?>" method="post">
							
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								
								<p>商品标题
										<input class="text-input small-input" type="text" id="small-input" name="title" value="<?php echo ($article['title']); ?>" />
								</p>
								...
								<p>库存
										<input class="text-input small-input" type="text" id="small-input" name="quantity" value="<?php echo ($article['quantity']); ?>" />
								</p>
								
								<p>价格
										<input class="text-input small-input" type="text" id="small-input" name="price" value="<?php echo ($article['price']); ?>" />
								</p>

								<p>图片1<input type="file"  name="photo[]"   multiple="multiple"></p>
								<p>立刻上架
								...
								<p>
									...
									<?php echo W('Editord',array($article['description']));?>
								</p>
								
								
								<p>
								<?php if(ACTION_NAME=='edit_article'): ?><input type="hidden" name="id" value="<?php echo ($article['id']); ?>" /><?php endif; ?>
