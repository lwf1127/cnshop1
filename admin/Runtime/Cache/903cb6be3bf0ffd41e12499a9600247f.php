						...
						<table>
							...
							<tbody>
								<?php if(is_array($goodss)): $i = 0; $__LIST__ = $goodss;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
									...
									<td><?php echo ($v['on_sale']); ?></td>
									<td>
<!--<a href="<?php echo U('Goods/delete_goods','id='.$v['gid']);?>" title="Delete"><img src="../Public/resources/images/icons/cross.png" alt="Delete" /></a> -->
<a href="<?php echo U('Goods/edit_goods','id='.$v['gid']);?>" title="Edit"><button>修改基本信息</button></a>
<a href="<?php echo U('Goods/edit_goods2','id='.$v['gid']);?>"><button>修改图片和描述</button></a>
									</td>
